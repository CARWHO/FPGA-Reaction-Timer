...
HD_PWD='D:/ThuGroup7/NewRefactoredCode/RT_vivadoProject/RT_vivadoProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Display_Controller_ms.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Display_Controller_ms.tcl -notrace
