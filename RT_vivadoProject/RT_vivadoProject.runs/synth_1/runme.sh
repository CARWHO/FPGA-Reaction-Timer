...
HD_PWD='D:/ThuGroup7/NewRefactoredCode/RT_vivadoProject/RT_vivadoProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Display_Controller_ms.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Display_Controller_ms.tcl
