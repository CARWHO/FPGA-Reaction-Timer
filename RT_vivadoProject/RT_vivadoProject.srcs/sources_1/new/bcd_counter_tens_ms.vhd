...
entity Tens_Counter is
    port (
        ...
        ROLLOVER  : out std_logic      -- High for one CLK cycle on rollover
    );
end Tens_Counter;

architecture Behavioral of Tens_Counter is
